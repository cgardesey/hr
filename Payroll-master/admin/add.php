        ...
        <div class="main">
            <div class="header">
                <div class="header_resize">
                    <div class="logo">
                        <h1><a href="adminhome.php">Ghana Education Service<small>Employee Payroll</small></a></h1>
                    </div>
                    ...
                    <div class="content_resize">
                        <div class="mainbar">
                            <div class="article">
                                ...
                                <?php
                                include_once '../dbfiles/config1.php';
                                ?>
                                <form name="add_emp" method="post" enctype="multipart/form-data" action="add_emp.php">
                                    <table style="width: 50%;margin: auto;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php $query= mysql_query("SELECT max(employeeid) as employeeid from employee");
                                                $result= mysql_fetch_array($query);
                                                ?>
                                                <input type="hidden" name="emp_id" value="<?php echo $result['employeeid']; ?>"/>
