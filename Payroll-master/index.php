...
<body>
    ...
    <div id="container">
		...
		<div id="content">
                    <span style="font-family: vhia; font-size: 50px;">PREP-EEZ</span>&nbsp;&nbsp;<img src="images/logo2.png" alt="LOGO" height="70px" width="70px" /><br/><br/><br/>
                    <span style="font-family: arial; font-size: 30px; color: #11673B; margin-left: 50%">Employee Payroll</span><br/><br/><br/>
