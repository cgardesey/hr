    ...
    <div class="row">
        <div class="col-md-12">
            ...
            $form = $this->beginWidget('CActiveForm', array(
                ...
                'action' => Yii::app()->createUrl('//core/employee/update/id/' . $model->employeeid),
                'htmlOptions' => array(
                                        ...
                                        <form action="#" role="form">
                                            ...
                                            <div class="form-group col-sm-6">
                                                ...
                                                <div data-date-format="dd-mm-yyyy" class="input-group date ebro_datepicker">
                                                   ...
                                                   echo $form->textField($model, 'employee_joiningdate', array('placeholder' => 'Joining Date', 'class' => "form-control date-picker"));
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                echo CHtml::activeDropDownList($model, 'divisionid',$division, array('empty' => 'Select Option', 'class' => "form-control"));
