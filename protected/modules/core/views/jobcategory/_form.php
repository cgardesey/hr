<div class="page-content" style="min-height:1683px">
    ...
    <h3 class="page-title">Job Category Details</h3>
    <div class="row">
        <div class="col-md-12">
            <div class="col-md-6">
                <?php
                ...
                /**
                 * _form is used to enter the job category details
                 */
                ?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            echo CHtml::activeDropDownList($model, 'departmentid', $department, array('empty' => 'Please Select', 'class' => "form-control",
                                'ajax' => array(
                                    'type' => 'POST',
                                    'url' => CController::createUrl('jobcategory/Fetchdivision'),
                        ...
                        <div class="form-group">
                            <label for="reg_input_name" class="req">Job Category Name </label>
                            <?php
                            //! Text field to enter name of the division
                            echo $form->textField($model, 'jobcategory_name', array('class' => "form-control"));
                            echo $form->error($model, 'jobcategory_name', array('class' => 'school_val_error'));
                            ?>                
                        </div>
                        <div class="row">
                            <div class="col-sm-5">
            ...
            <div class="col-md-6">
                <?php
                //! Used to display all created values of job category details.
