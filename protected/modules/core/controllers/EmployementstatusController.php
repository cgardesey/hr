...
class EmployementstatusController extends Controller
{
	...
	{
		$model=new Employementstatus;

		// Uncomment the following line if AJAX validation is needed
		 $this->performAjaxValidation($model);

		if(isset($_POST['Employementstatus']))
		{
			$model->attributes=$_POST['Employementstatus'];
...
//                    echo $error;
	 ...
	 * @return Employementstatus the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Employementstatus::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Employementstatus $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='employementstatus-form')
		{
