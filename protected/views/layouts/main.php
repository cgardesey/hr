...
<html lang="en">
    <head>
        ...
        <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/pages/css/profile.min.css" rel="stylesheet" type="text/css" />
        <!-- END HEAD -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                <div class="page-logo">
                    <a href="#"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/logo.png" alt="logo" width="150" class="logo-default" /> </a>
...
<!--                    <li class="dropdown dropdown-quick-sidebar-toggler">
                           ...
                           if (Yii::app()->user->usertypeid === '0') {
                            ...
                            <li class="nav-item  ">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="nav-item  "><a href="Payroll-master/index.php" class="nav-link "><span class="title">Staff Payroll</span> </a></li>
        ...
        <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/css/custom.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl; ?>/css/country.js"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/pages/scripts/profile.min.js" type="text/javascript"></script>
        <!-- BEGIN PAGE LEVEL PLUGINS -->
