...
<html lang="en">
    <head>
        ...
        <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/global/plugins/select2/css/select2.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/global/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />
        ...
        <link href="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/pages/css/login-4.min.css" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        <div class="logo">
            <a href="index.html"><img src="<?php echo Yii::app()->request->baseUrl; ?>/img/logoHF.png" alt="" /> </a>
      </div>
        <div class="content">
            <?php  echo $content; ?>
                </div>
      
        <div class="copyright"> 2018 &copy; Copyright © 2018 Human Resource Management System, Prep-eez  </div>
        ...
        <!-- END CORE PLUGINS -->
        <!-- BEGIN PAGE LEVEL PLUGINS -->
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/global/plugins/jquery-validation/js/jquery.validate.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/global/plugins/jquery-validation/js/additional-methods.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/global/plugins/select2/js/select2.full.min.js" type="text/javascript"></script>
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/global/plugins/backstretch/jquery.backstretch.min.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/css/assets/pages/scripts/login-4.min.js" type="text/javascript"></script>
